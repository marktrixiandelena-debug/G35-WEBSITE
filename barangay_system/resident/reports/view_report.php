...
$backUrl = 'my_reports.php';
if (!empty($_GET['returnto'])) {
    $cleanRt = preg_replace('/[^a-zA-Z0-9=&_%+.-]/', '', $_GET['returnto']);
    if ($cleanRt) $backUrl = 'my_reports.php?' . $cleanRt;
}
    ...
    <div class="dashboard-container">
        <aside class="sidebar">
            ...
            <ul>
                ...
                <li><a href="../help/faq.php"><i class="fa-solid fa-circle-question"></i> FAQ & Help</a></li>
            </ul>
        </aside>
        ...
        <main class="content">
            ...
            <div class="page-header-flex">
                ...
                <div style="display: flex; flex-direction: column; align-items: flex-end; gap: 0.75rem;">
                    <a href="<?php echo htmlspecialchars($backUrl); ?>" class="action-btn btn-back-nav" style="margin: 0;">
                        <i class="fa-solid fa-arrow-left"></i> Back to My Reports
                    </a>
                    <span class="status-badge status-<?php echo $report['status']; ?>" style="padding: 0.4rem 1rem; font-size: 0.9rem;">
