...
| Feature | Description |
|---|---|
| Admin Inbox | Centralized view of all reports with advanced filtering and search |
...
**Portal:** Admin
**Directory:** `admin/logs/`, `admin/dashboard/` (analytics.php)
**DB Table:** `audit_logs`
...
| Feature | Description |
|---|---|
| Analytics Dashboard | Visual trends (Incident Type, Severity) and Ranked Affected Areas |
