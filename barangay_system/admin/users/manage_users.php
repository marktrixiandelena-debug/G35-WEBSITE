...
// Build state-preserving return URL
        ...
        <main class="content">
                        ...
                        <?php while ($user = $users->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td data-label="Action" style="white-space: nowrap;">
                                    ...
                                    <a href="view_user.php?id=<?php echo $user['id']; ?><?php echo $returnQS ? '&returnto=' . urlencode($returnQS) : ''; ?>" class="action-btn btn-view">
            ...
            <div class="info-highlight" style="margin-top: 2rem;">
                ...
                <div class="info-content">
                    ...
                    <p>Disabling a user account revokes access while preserving their historical report data and activity for official audit purposes.</p>
                </div>
            </div>
    ...
    <?php if (isset($_SESSION['new_user_success'])): ?>
        <div id="successModal" class="form-modal" style="display: flex;">
            <div class="modal-content" style="max-width: 450px; text-align: center;">
                ...
                <div style="width: 56px; height: 56px; background: #dcfce7; color: #166534; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 1.5rem; margin: 0 auto 1rem auto;">
                    <i class="fa-solid fa-check"></i>
                </div>
                <h3 style="margin-top: 0; margin-bottom: 0.5rem; color: #111827; font-size: 1.25rem;">User Created Successfully</h3>
                <p style="color: #4b5563; font-size: 0.95rem; margin-bottom: 1.25rem;">
                    Please provide these credentials to <strong><?php echo htmlspecialchars($_SESSION['new_user_name']); ?></strong>
                </p>

                <div style="background: #f8fafc; border: 1px solid #e2e8f0; padding: 1.25rem; border-radius: 0.5rem; text-align: left; margin-bottom: 1.25rem;">
                    <div style="margin-bottom: 1.15rem;">
                        <span style="display: block; font-size: 0.75rem; font-weight: 600; color: #64748b; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 0.3rem;">Username</span>
                        <div style="font-family: monospace; font-size: 1.1rem; color: #0f172a; font-weight: 600; background: #f1f5f9; display: inline-block; padding: 0.4rem 0.75rem; border-radius: 0.375rem; border: 1px solid #e2e8f0;">
                            <?php echo htmlspecialchars($_SESSION['new_user_username']); ?>
                        </div>
                    </div>
                    <div>
                        <span style="display: block; font-size: 0.75rem; font-weight: 600; color: #64748b; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 0.3rem;">Temporary Password</span>
                        <div style="display: flex; align-items: center; gap: 0.5rem;">
                            <div style="font-family: monospace; font-size: 1.25rem; color: #1d4ed8; font-weight: 700; letter-spacing: 1px; background: #eff6ff; padding: 0.4rem 0.75rem; border-radius: 0.375rem; border: 1px solid #bfdbfe;">
                                <?php echo htmlspecialchars($_SESSION['new_user_password']); ?>
                            </div>
                            <button type="button" onclick="navigator.clipboard.writeText('<?php echo htmlspecialchars($_SESSION['new_user_password']); ?>').then(() => { this.innerHTML = '<i class=\'fa-solid fa-check\' style=\'color:#16a34a\'></i>'; setTimeout(() => this.innerHTML = '<i class=\'fa-regular fa-copy\'></i>', 2000); })" style="background: none; border: none; font-size: 1.15rem; color: #64748b; cursor: pointer; padding: 0.25rem; display: flex; align-items: center; justify-content: center; width: 32px; height: 32px; transition: color 0.2s;" title="Copy Password" onmouseover="this.style.color='#0f172a'" onmouseout="this.style.color='#64748b'">
                ...
                <div class="info-note" style="text-align: left; background: #f0fdf4; border-left: 4px solid #22c55e; padding: 0.85rem 1rem; border-radius: 0.25rem; font-size: 0.85rem; color: #166534; margin-bottom: 1.5rem; display: flex; gap: 0.6rem; align-items: flex-start;">
                    <i class="fa-solid fa-circle-info" style="font-size: 1.1rem; margin-top: 0.1rem;"></i>
                    <div style="line-height: 1.4;">This temporary password will only be shown once. Please securely provide it to the user before closing this window.</div>
                </div>
    ...
    <?php if (isset($_SESSION['reset_success'])): ?>
        <div id="resetModal" class="form-modal" style="display: flex;">
            <div class="modal-content" style="max-width: 450px; text-align: center;">
                ...
                <div style="width: 56px; height: 56px; background: #e0e7ff; color: #4338ca; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 1.5rem; margin: 0 auto 1rem auto;">
                    <i class="fa-solid fa-key"></i>
                </div>
                <h3 style="margin-top: 0; margin-bottom: 0.5rem; color: #111827; font-size: 1.25rem;">Password Reset Successful</h3>
                <p style="color: #4b5563; font-size: 0.95rem; margin-bottom: 1.25rem;">
                ...
                <div style="background: #f8fafc; border: 1px solid #e2e8f0; padding: 1.25rem; border-radius: 0.5rem; text-align: left; margin-bottom: 1.25rem;">
                    ...
                    <div>
                        <span style="display: block; font-size: 0.75rem; font-weight: 600; color: #64748b; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 0.3rem;">New Temporary Password</span>
                        <div style="display: flex; align-items: center; gap: 0.5rem;">
                            <div style="font-family: monospace; font-size: 1.25rem; color: #1d4ed8; font-weight: 700; letter-spacing: 1px; background: #eff6ff; padding: 0.4rem 0.75rem; border-radius: 0.375rem; border: 1px solid #bfdbfe;">
                                <?php echo htmlspecialchars($_SESSION['reset_temp_password']); ?>
                            </div>
                            <button type="button" onclick="navigator.clipboard.writeText('<?php echo htmlspecialchars($_SESSION['reset_temp_password']); ?>').then(() => { this.innerHTML = '<i class=\'fa-solid fa-check\' style=\'color:#16a34a\'></i>'; setTimeout(() => this.innerHTML = '<i class=\'fa-regular fa-copy\'></i>', 2000); })" style="background: none; border: none; font-size: 1.15rem; color: #64748b; cursor: pointer; padding: 0.25rem; display: flex; align-items: center; justify-content: center; width: 32px; height: 32px; transition: color 0.2s;" title="Copy Password" onmouseover="this.style.color='#0f172a'" onmouseout="this.style.color='#64748b'">
                                <i class="fa-regular fa-copy"></i>
                            </button>
                        </div>
                    </div>
                ...
                <div class="info-note" style="text-align: left; background: #f0fdf4; border-left: 4px solid #22c55e; padding: 0.85rem 1rem; border-radius: 0.25rem; font-size: 0.85rem; color: #166534; margin-bottom: 1.5rem; display: flex; gap: 0.6rem; align-items: flex-start;">
                    <i class="fa-solid fa-circle-info" style="font-size: 1.1rem; margin-top: 0.1rem;"></i>
                    <div style="line-height: 1.4;">This new temporary password will only be shown once. Please securely provide it to the user.</div>
                </div>
        ...
        <div class="modal-content" style="max-width: 600px;">
            ...
            <form action="process_create_user.php" method="POST">
                ...
                <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 0.5rem; padding: 1rem; margin-top: 1.5rem; display: flex; gap: 1rem; align-items: flex-start;">
                    ...
                    <div>
                        <p style="margin: 0 0 0.4rem 0; font-weight: 600; font-size: 0.95rem; color: #0f172a;">Account Security</p>
                        <p style="margin: 0; font-size: 0.85rem; color: #4b5563; line-height: 1.5;">A secure temporary password will be automatically generated for this account. Users will be required to create a new personal password during first login.</p>
                    </div>
                </div>
