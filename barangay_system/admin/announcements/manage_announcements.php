        ...
        <main class="content">
            ...
            <div class="info-highlight" style="margin-bottom: 1.5rem;">
                ...
                <div class="info-content">
                    <h4>Visibility Logic:</h4>
                    <p><strong>Active</strong> advisories are visible to residents. Use <strong>Inactive</strong> status to hide announcements while preserving them for administrative history.</p>
                </div>
            </div>
