...
<body>
    ...
    <div class="dashboard-container">
        ...
        <main class="content">
            ...
            <p>Welcome to the administrative dashboard. Use the menu to manage users and monitor reports.</p>

            <!-- ALERT BANNER -->
            <?php if ($pendingReports > 0): ?>
                <div class="alert-box">
                    <strong>Action Required:</strong> You have <?php echo $pendingReports; ?> pending report(s) that require
                    review.
                </div>
            <?php endif; ?>
