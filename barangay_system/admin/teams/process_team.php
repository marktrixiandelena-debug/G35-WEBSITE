...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($action == 'create') {
        ...
        if ($stmt->execute()) {
            ...
            logActivity($conn, $_SESSION['user_id'], 'Create Team', "New response team \"$team_name\" registered — Leader: $team_leader");
        ...
        if ($stmt->execute()) {
            require_once "../../includes/logger.php";
            logActivity($conn, $_SESSION['user_id'], 'Update Team', "Updated details for response team \"$team_name\"");
