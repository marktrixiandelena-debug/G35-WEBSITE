                        ...
                        <?php while ($row = $reports->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td data-label="Action">
                                    <a href="report_details.php?id=<?php echo $row['id']; ?>" class="action-btn btn-view" style="width: auto; margin-bottom: 0.5rem; text-align: center; display: inline-flex; justify-content: center;">
