...
$guest_name    = ($reporter_type === 'guest') ? formatName($_POST['guest_name'] ?? '') : null;
...
$details = "Manually filed " . ucfirst($type) . " report for {$resident_name} at {$location_details}, {$location} (Report #{$new_report_id}, Source: {$source_label})";
