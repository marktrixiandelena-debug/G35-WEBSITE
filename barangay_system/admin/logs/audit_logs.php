...
// Optimization: Limit to recent 100 entries for system performance
        ...
        <main class="content">
            ...
            <div class="info-highlight" style="margin-top: 1.5rem;">
                ...
                <div class="info-content">
                    ...
                    <p>Audit logs are immutable tracking records generated automatically by the system. They cannot be edited or deleted by any user or administrator. Displaying up to the 100 most recent events.</p>
                </div>
            </div>
