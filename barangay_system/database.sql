...
INSERT IGNORE INTO `users` (`full_name`, `username`, `password`, `role`, `status`) 
VALUES ('Mark Trixian Deleña', 'mark.td', '$2a$12$fw1oGmUTfM6SGCFDSvDI5O8Kc7n7pB88.dCE/Y0wW4cHHFb0kKX3a', 'admin', 'active');