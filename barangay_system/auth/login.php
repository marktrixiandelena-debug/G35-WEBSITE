    ...
    <div class="auth-container">
        <div class="auth-header">
            <img src="../assets/images/barangay_logo.jpg" alt="Barangay Calauag Seal"
                style="width: 100px; height: 100px; margin: 0 auto 1rem auto; display: block; border-radius: 50%; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
            <h2>Authorized Login</h2>
            <p>Please allow access to your account</p>
        </div>
