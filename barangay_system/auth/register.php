...
<body class="bg-login">
    <div class="auth-container">
        <div class="auth-header" style="margin-bottom: 1.25rem;">
            <img src="../assets/images/barangay_logo.jpg" alt="Barangay Calauag Seal"
                style="width: 85px; height: 85px; margin: 0 auto 0.75rem auto; display: block; border-radius: 50%; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
    ...
    <script src="../assets/js/auth/password_toggle.js"></script>
        ...
        function checkUsername(uname) {
            ...
            if (!uname) { statusSpan.textContent = ''; return; }
